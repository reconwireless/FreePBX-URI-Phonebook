Installing FreePBX URI Phonebook Module<br>
<?php
...
// Need to add check here to check existing mysql table, 
...
$includecontent = "#include custom_uribook.conf\n";
...
if($res->numRows() != 1)
{
$sql = "INSERT INTO	cronmanager (module,id,time,freq,command) VALUES ('uribook','every_day',23,24,'/usr/bin/find /var/lib/asterisk/sounds/tts -name \"*.wav\" -mtime +1 -exec rm {} \\\;')";
...
<?php
// Register FeatureCode - URI Phonebook;
$fcc = new featurecode('uribook', 'uribook');
$fcc->setDescription('URI Phonebook');
$fcc->setDefault('1200');
$fcc->update();
unset($fcc);
?>
